...
if($codigo > 0){
    $empresaBean = $empresa->c_buscar_empresa_por_codigo($codigo);  
}

if($acao != ""){
    if($acao == "incluir"){
        $empresa->c_gravar_empresa();
        header("Location:ConsultarEmpresa.php");
    }
     if ($acao == "alterar") {
        $empresa->c_alterar_empresa();
        header("Location:ConsultarEmpresa.php");
    }
    if ($acao == "excluir") {
        $empresa->c_excluir_empresa();
        header("Location:ConsultarEmpresa.php");
    }
}
?>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class=" text-center "><b>Cadastro de Empresa</b></h6>
                    </div>
                    <div class="panel-body">
                        <div class="row">                              
                            <form action="CadastrarEmpresa.php" method="post">
                                ...
                                <input type="hidden" name="emp_id"   id="emp_id" value="<?php echo $empresaBean->getEmp_id()?>"/>
                                
                                <div class="form-group col-md-1">
                                    <label for="disabledSelect">Código:</label>
                                    <input class="form-control" disabled type="text" name="emp_id" id="emp_id" value="<?php echo $empresaBean->getEmp_id()?>"/>
                                </div> 
                                <div class="form-group col-md-2">
                                    <label>Cnpj:</label> 
                                    <input class="form-control"  type="text" name="emp_cnpj"  onblur="checkCnpj(this.value)" data-mask="00.000.000/0000-00" value="<?php echo $empresaBean->getEmp_cnpj() ?>" placeholder="00.000.000/0000-00" autocomplete="off" />
                                </div>
                                <div class="form-group col-md-5">
                                    <label>Nome:</label>
                                    <input class="form-control"  type="text" name="emp_nome" id="emp_nome"  value="<?php echo $empresaBean->getEmp_nome() ?>"  autocomplete="off" >                                        
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Nome Fantasia:</label>
                                    <input class="form-control"  type="text" name="emp_nomeFantasia" id="emp_nomeFantasia"  value="<?php echo $empresaBean->getEmp_nomeFantasia() ?>"  autocomplete="off" autofocus="on">                                        
                                </div>
                                <!-- Inicio DA NAV -->
                                <div>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input class="form-control"  type="text" name="emp_ie" id="emp_ie" data-mask="00.000.000-00" value="<?php echo $empresaBean->getEmp_ie()?>"  placeholder="00.000.000-00"  autocomplete="off">                                   
                                                    </div>
                                                    <div class="form-group col-md-2">
                                ...
                                <div class="col-md-12">   
                                    ...
                                    <a target="Frame1" href="ConsultarEmpresa.php" class="btn btn-danger"><i class="glyphicon glyphicon-refresh" aria-hidden="true"></i>&nbsp;Cancelar</a>
                                </div>
                            </form>                                                                                                                                       
                        </div>
                    </div>
